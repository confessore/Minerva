...
namespace Minerva.Web.Services
{
    public class DiscordService : IDiscordService
    {
        ...
        public async Task<IEnumerable<DiscordConnection>> GetUserConnectionsAsync(UserManager<ApplicationUser> userManager, ApplicationUser user)
        {
            ...
            return await response.Content.ReadAsAsync<IEnumerable<DiscordConnection>>();
        }
        ...
        async Task RenewAccessTokenAsync(UserManager<ApplicationUser> userManager, ApplicationUser user)
        {
            ...
            var parameters = new Dictionary<string, string>()
            {
                ...
                { "refresh_token", token },
#if DEBUG
                { "redirect_uri", "https://localhost:44362/signin-discord" },
#else
                { "redirect_uri", "https://localhost:44362/signin-discord" },
#endif
